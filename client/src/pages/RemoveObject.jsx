...
const RemoveObject = () => {
    ...
    return (
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <p className='mt-6 text-sm font font-medium'>Upload image</p>
        ...
        <p className='mt-6 text-sm font font-medium'>Describe Object name to remove</p>
        ...
        bg-gradient-to-r from-[#417DF6] to-[#8E37EB] text-while px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
          {
